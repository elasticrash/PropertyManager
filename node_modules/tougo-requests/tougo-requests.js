...
app.get('/api/payment/list', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        // SQL Query > Select Data
        var qstring = qb.select('*') + qb.from('prop_pay')
            +qb.leftjoin('prop_pay','property', 'property_id')
            +qb.leftjoin('prop_pay','tenant', 'tenant_id')
            +qb.leftjoin('prop_pay','payment', 'payment_id')
            +qb.leftjoin('payment','month', 'month_id');
        console.log(qstring);
...
app.post('/api/property/add', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        var qstring = qb.insertinto("property", attributes, values);
        console.log(qstring);
...
app.post('/api/property/update', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        var qstring = qb.update("property", attributes, values)+qb.where(keyexpression);
        console.log(qstring);
...
app.post('/api/property/delete', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        // SQL Query > Select Data
        var qstring = qb.delete()+qb.from('property')+qb.where("property_id="+req.query["property_id"]);
        console.log(qstring);
...
app.post('/api/payment/add', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        var qstring = qb.insertintowithoutputid("payment", sattributes, svalues, "payment_id");
        console.log(qstring);
        ...
        query.on('end', function() {
            ...
            var q2string = qb.insertinto("prop_pay",Rattributes, Rvalues);
            console.log(q2string);
            var secondquery = client.query(q2string);
            return res.json(results);
        });
...
app.post('/api/connect/update', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        var qstring = qb.update("property", upid, upvalue)+qb.where("property_id="+req.query.property_id);
        console.log(qstring);
