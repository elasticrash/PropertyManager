...
app.post('/api/disconnect/tenant', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        attributes.push("tenant_id");
        values.push("null");

        keyexpression = "property_id = "+req.query["property_id"];
...
app.post('/api/payment/delete', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        // SQL Query > Select Data
        var q = new qb;
        var qstring = q.delete().from('payment').where("payment_id="+req.query["payment_id"]);
        console.log(qstring.query);
        ...
        query.on('end', function() {
            ...
            var b = new qb;
            var q2string = b.delete().from('prop_pay').where("payment_id="+req.query["payment_id"]);
            console.log(q2string.query);
            return res.json(results);
        });
